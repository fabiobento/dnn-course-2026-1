...
- ganhará experiência prática na implementação de redes *feedforward*.

Por meio de exercícios práticos, você compreenderá a matemática por trás das redes neurais enquanto desenvolve habilidades práticas que servirão de base para técnicas mais avançadas.

## Conteúdo

1. [Introdução ao Deep Learning e Redes Neurais](./intro-dl/intro-dl.md)
